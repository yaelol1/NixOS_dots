...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(fountain-mode focus)
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-jump-helm-line ace-link ace-window add-node-modules-path aggressive-indent
                          all-the-icons anaconda-mode annalist anzu async
                          ...
                          holy-mode ht hungry-delete hybrid-mode hydra
                          ibuffer-projectile iedit imenu-list impatient-mode
